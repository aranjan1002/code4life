/*--------This file conatains the defintion of MinleftistTree class, which encompasses all the functions required to perform delelte and insert operations in a Min Leftist tree.--------*/
...
void displaytree(LeftistNode *node, ofstream &outputfile)		//displays the structure of the tree by performing level order traversal
{
