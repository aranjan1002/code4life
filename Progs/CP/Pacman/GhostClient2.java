...
public class GhostClient2 extends JFrame implements KeyListener{
	...
	private static final String REGMSG = "REG bee G";
	...
	private void sendToServer(String msg)
	{
		...
		if (board.gameState == 1) {
			...
			sb.append(board.getGhostClientX(myClientIdx))
			.append(" ")
			.append(board.getGhostClientY(myClientIdx))
			.append(" ")
			.append(msg);
			msg = sb.toString();
		}
	...
	{
		GhostClient2 client = new GhostClient2();
		client.run();
	}
