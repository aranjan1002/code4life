...
# ---------------------------------------------------------------------------
#
# admipex5.py --- Solving noswot by adding user cuts to IloCplex
#
...
import cplex
from cplex.callbacks import CutCallback
...
def admipex5():
    ...
    # need to disable non-linear presolving reductions since our cut callback
    # operates on the original model
    c.parameters.preprocessing.linear.set(0)
    
    # install the cut callback
