...
if __name__ == "__main__":
    ...
    # Setup pattern generation (slave) problem.
    ...
    while True:
        ...
        # slave problem is constructed from the dual values of the
