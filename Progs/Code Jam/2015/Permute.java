...
public class Permute {
	...
	List<List<Integer>> result = getPermutations(l, 4);
    ...
    public void permute(List<Integer> curr_index_list, 
	    ...
	    //System.out.println(permutations_so_far);
	    if (permutations_so_far.size() > 0) {
		if (permutations_so_far.get(0).size() >= permute_length) {
		    result.addAll(permutations_so_far);
		    return;
		}
	    }
